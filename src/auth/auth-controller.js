...
exports.register = async (req, res) => {
    //#swagger.tags = ['Auth']
    //#swagger.description = 'Service to register a new user into cars api'
    //#swagger.summary = 'Service to register a new user into cars api'
    const {
...
exports.signIn = async (req, res) => {
    //#swagger.tags = ['Auth']
    //#swagger.description = 'Service to register a new user into api & get jwt token for stateless auth'
    //#swagger.summary = 'Service to register a new user into api & get jwt token for stateless auth'
    const {
        email, password
    } = req.body;
...
exports.getCurrentUser = async (req, res) => {
    //#swagger.tags = ['Auth']
    //#swagger.description = 'Service to register a new user into api & get jwt token for stateless auth'
    //#swagger.summary = 'Service to get authenticated user data'
    /*#swagger.security = [{
                "Bearer": []
        }]*/
