module.exports = app => {
    ...
    router.get("/colors/get/:id", jwtMiddleware.checkJwtTokenMiddleware, colors.getColor); // path to get a color

    router.get("/colors/get", jwtMiddleware.checkJwtTokenMiddleware, colors.getAllColor); // path to get all colors
